...
This is the original version of this plot and the dataset. In fact, this dataset started out as electrochemical potentials hard-coded in the TikZ code. But despite that lack of adaptability, the visual quality of the plot surpasses both the base plot and the gpplot above (perhaps not for much longer). In fact, a slightly modified version of this plot was published in \textcite{Zhu2012} and \textcite[p.\ 397]{Zhu2015}.
